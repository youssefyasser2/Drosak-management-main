...
class RoutesManager {
  static Map<String, WidgetBuilder> routes = {
    ...
    // RoutesName.kHomeScreenRoute: (context) => const HomeScreen(),
    RoutesName.kLoginScreenRoute: (context) => const LoginScreen(),
    RoutesName.kRegisterScreenRoute: (context) => const RegisterScreen(),
    RoutesName.kForgotPasswordScreenRoute: (context) => const ForgotPasswordScreen(),
  };
}
...
class RoutesName {
  ...
  static const String kHomeScreenRoute = '/kHomeScreenRoute';
